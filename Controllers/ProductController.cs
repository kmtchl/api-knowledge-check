...
public class ProductsController(IProductRepository productRepository, IProductValidator validator) : ControllerBase
{
    [HttpGet]
    ...
    {
        if (id <= 0) return BadRequest("Product Id cannot be less than or equal to 0");
